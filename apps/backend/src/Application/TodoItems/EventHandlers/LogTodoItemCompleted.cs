using Alexandria.Domain.Events;
using Microsoft.Extensions.Logging;

namespace Alexandria.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("Alexandria Domain Event: {DomainEvent}", notification.GetType().Name);
